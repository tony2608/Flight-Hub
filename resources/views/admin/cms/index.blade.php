...
<head>
    ...
    <title>Admin Dashboard - Flight Hub</title>
...
<body>
    ...
    {{-- NAVBAR ATAS KHUSUS ADMIN --}}
    <nav class="navbar navbar-dark bg-dark mb-4 shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#"><i class="fas fa-desktop me-2 text-warning"></i> Admin Portal</a>
            <div class="d-flex align-items-center">
                <span class="text-white me-3 small"><i class="fas fa-user-shield me-1"></i> {{ Auth::user()->name }} (Admin)</span>
    ...
    <div class="container pb-5">
        ...
        <form action="{{ route('admin.cms.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12"> {{-- Diubah jadi col-lg-12 biar full width --}}
    ...
    {{-- Wajib panggil script Bootstrap biar accordion-nya bisa diklik --}}
